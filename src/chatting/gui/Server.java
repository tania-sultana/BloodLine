...
public class Server implements ActionListener ,Runnable{
    ...
    public Server(Datas userInfo){
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource(userInfo.getImage()));//"chatting/gui/images/tania.png"
        ...
        JLabel l3 = new JLabel(userInfo.getName());
